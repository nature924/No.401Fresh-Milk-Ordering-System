            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiannai' ">
                    <el-form-item class="input" v-if="type!='info'"  label="剩余订购数量" prop="xiannaiKucunNumber">
                        <el-input v-model="xiannaiForm.xiannaiKucunNumber"
                                  placeholder="剩余订购数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiannai' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="xiannaiOldMoney">
                        <el-input v-model="xiannaiForm.xiannaiOldMoney"
                ...
                <el-col :span="12"  v-if="sessionTable !='xiannai' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="xiannaiClicknum">
                        <el-input v-model="xiannaiForm.xiannaiClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="xiannaiClicknum">
                            <el-input v-model="ruleForm.xiannaiClicknum"
